...
var Chat = {
    ...
    receiveMessage: function (msg) {
        ...
        Chat.log("message received: ", elems);
...
function createRoom()
{
    var room_name = $('#room').val() + '@localhost/' + sessionStorage.getItem("username");;
...
function joinGroup()
{
    ...
    var nickname = sessionStorage.getItem("user_name");;
...
function login()
{
    var jid = $('#user_name').val() + '@localhost', password = $('#password').val();
